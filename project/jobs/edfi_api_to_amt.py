...
edfi_api_endpoints = [
    ...
    # {"endpoint": "/ed-fi/surveys/deletes", "table_name": "base_edfi_surveys_deletes" },
    # {"endpoint": "/ed-fi/surveyQuestions", "table_name": "base_edfi_survey_questions" },
    # {"endpoint": "/ed-fi/surveyQuestions/deletes", "table_name": "base_edfi_survey_questions_deletes" },
    # {"endpoint": "/ed-fi/surveyResponses", "table_name": "base_edfi_survey_responses" },
    # {"endpoint": "/ed-fi/surveyResponses/deletes", "table_name": "base_edfi_survey_responses_deletes" },
    # {"endpoint": "/ed-fi/surveyQuestionResponses", "table_name": "base_edfi_survey_question_responses" },
    # {"endpoint": "/ed-fi/surveyQuestionResponses/deletes", "table_name": "base_edfi_survey_question_responses_deletes" },
